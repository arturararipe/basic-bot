...
const bot = new Fosscord.Client({
        intents: ["GUILD_MESSAGES,GUILD_MEMBER_ADD,MESSAGE_CREATE"],
...
bot.on('guildMemberAdd', member => {
    ...
    const welcomeEmbed = new Fosscord.MessageEmbed()
    ...
    member.guild.channels.cache.find(i => i.name === 'general').send(welcomeEmbed)
})

bot.on('guildMemberRemove', member => {
    const goodbyeEmbed = new Fosscord.MessageEmbed()
